                                    ...
                                    <div class="card-body invoice-head"> 
                                        <div class="row">
                                            <div class="col-md-4 align-self-center">                                                
                                                <img src="admin/assets/images/logo-sm.png" alt="logo-small" class="logo-sm mr-2" height="38">                                            
                                                <img src="admin/assets/images/logo-dark.png" alt="logo-large" class="logo-lg" height="18">                                               
                                            </div>
                                            <div class="col-md-8">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-lg-6 align-self-end">
                                                <div class="w-25 float-right">
                                                    ...
                                                    <img src="admin/assets/images/signature.png" alt="" class="" height="48">
