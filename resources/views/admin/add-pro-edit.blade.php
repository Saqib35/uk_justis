                                            ...
                                            <form action="{{url('add-client-update')}}" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select class="form-control" name="country" required="">
                                                                ...
                                                                @foreach ($Country as $Country)
                                                                 <option value="{{ $Country['sortname']  }}" @if($Client[0]->country==$Country['sortname']){{ "selected" }} @endif > {{ $Country['name']  }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="form-group col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="input-group mb-3">
                                                           <img src="{{ asset($Client[0]->profile_img) }}" width="130px" height="130px">    
                                                        </div>                                    
                                                    </div>
                                                    <div class="form-group col-sm-6 col-xs-12">
                                                        <div class="preview1">
