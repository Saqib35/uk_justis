                                    ...
                                    <div class="card-body">
                                        <div class="wrap">
                                            ...
                                            <div class="js-conveyor-example">
                                                <ul>
                                                    <li>
                                                        <img src="admin/assets/images/products/img-4.png" alt="" class="thumb-sm rounded">
                                                        <span class="text-primary font-14"><b>Purse</b></span>
                                                        <span class="text-muted mb-0 font-12 ">14Feb 2019</span>
                                                    </li>
                                                    <li>
                                                        <img src="admin/assets/images/products/img-5.png" alt="" class="thumb-sm rounded">
                                                        <span class="text-primary font-14"><b>Shoes</b></span>
                                                        <span class="text-muted mb-0 font-12 ">14Feb 2019</span>
                                                    </li>
                                                    <li>
                                                        <img src="admin/assets/images/products/img-3.png" alt="" class="thumb-sm rounded">
                                                        <span class="text-primary font-14"><b>Head Phone</b></span>
                                                        <span class="text-muted mb-0 font-12 ">14Feb 2019</span>
                                                    </li>
                                                    <li>
                                                        <img src="admin/assets/images/products/img-2.png" alt="" class="thumb-sm rounded">
                                                        <span class="text-primary font-14"><b>Watch</b></span>
                                                        <span class="text-muted mb-0 font-12 ">14Feb 2019</span>
                                                    </li>
                                                    <li>
                                                        <img src="admin/assets/images/products/img-1.png" alt="" class="thumb-sm rounded">
                                                        <span class="text-primary font-14"><b>Bag</b></span>
                                                        <span class="text-muted mb-0 font-12 ">14Feb 2019</span>
                                                    </li>
                                                    <li>
                                                        <img src="admin/assets/images/products/img-6.png" alt="" class="thumb-sm rounded">
                                        ...
                                        <div class="tab-content" id="profile-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="profile-activities">
                                                ...
                                                <div class="activity">
                                                    ...
                                                    <img src="admin/assets/images/users/user-8.jpg" alt="" class="img-activity">                                                                                                            
                                                    <div class="time-item">
                                                        <div class="item-info">
                                                    ...
                                                    <img src="admin/assets/images/users/user-6.jpg" alt="" class="img-activity">
                                                    <div class="time-item ">
                                                        <div class="item-info">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>1</td>
                                                                <td><img src="admin/assets/images/products/img-2.png" alt="" class="thumb-sm rounded-circle mr-2">Watch</td>
                                                                <td>Rado</td>
                                                                <td>F500</td>
                                                            ...
                                                            <tr>
                                                                <td>2</td>
                                                                <td><img src="admin/assets/images/products/img-4.png" alt="" class="thumb-sm rounded-circle mr-2">Purse</td>
                                                                <td>Lavie</td>
                                                                <td>P500</td>
                                                            ...
                                                            <tr>
                                                                <td>3</td>
                                                                <td><img src="admin/assets/images/products/img-5.png" alt="" class="thumb-sm rounded-circle mr-2">Shoes</td>
                                                                <td>Reebok</td>
                                                                <td>R400</td>
                                                            ...
                                                            <tr>
                                                                <td>4</td>
                                                                <td><img src="admin/assets/images/products/img-3.png" alt="" class="thumb-sm rounded-circle mr-2">Headphone</td>
                                                                <td>MI</td>
                                                                <td>Mi450</td>
                                                ...
                                                <div class="new-product mt-5">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="new-product-img">
                                                                <div class="card-body text-center">
                                                                    <img src="admin/assets/images/products/img-1.png" alt="" height="220" class="">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="new-product-img">
                                                                <div class="card-body text-center">
                                                                    <img src="admin/assets/images/products/img-5.png" alt="" height="220" class="">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="new-product-img">
                                                                <div class="card-body text-center">
                                                                    <img src="admin/assets/images/products/img-3.png" alt="" height="220" class="">
