<div class="left-sidenav">
                    ...
                    <ul class="metismenu left-sidenav-menu" id="side-nav">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="mdi mdi-cards-outline"></i><span>Website Management</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('admin-details') }}"><span>Header & Footer</span></a></li>
                                <li><a href="{{ url('admin-slider') }}"><span>Slider</span></a></li> 
                                <li><a href="{{ url('admin-achivement') }}"><span>Achivements</span></a></li>
                                <li><a href="{{ url('admin-about') }}"><span>About</span></a></li>
                                <li><a href="{{ url('admin-faq') }}"><span>FAQs</span></a></li>
                                <li><a href="{{ url('admin-privacy-policy') }}"><span>Privacy Policy</span></a></li>
                                <li><a href="{{ url('admin-terms-conditions') }}"><span>Terms & Conditions</span></a></li>
                            </ul>
                        </li>
